...
#define KEY_ACTION_LIST(X) \
	...
	X(ka_count,                           COUNT,                            ,                                         "vis-count",                           "Count specifier") \
	...
	X(ka_earlier,                         EARLIER,                          ,                                         "vis-earlier",                         "Goto older text state") \
	...
	X(ka_insert_register,                 INSERT_REGISTER,                  ,                                         "vis-insert-register",                 "Insert specified register content") \
	X(ka_insert_verbatim,                 INSERT_VERBATIM,                  ,                                         "vis-insert-verbatim",                 "Insert Unicode character based on code point") \
	...
	X(ka_later,                           LATER,                            ,                                         "vis-later",                           "Goto newer text state") \
	X(ka_macro_record,                    MACRO_RECORD,                     ,                                         "vis-macro-record",                    "Record macro into given register") \
	X(ka_macro_replay,                    MACRO_REPLAY,                     ,                                         "vis-macro-replay",                    "Replay macro, execute the content of the given register") \
	X(ka_mark,                            MARK,                             ,                                         "vis-mark",                            "Use given mark for next action") \
	...
	X(ka_nop,                             NOP,                              ,                                         "vis-nop",                             "Ignore key, do nothing") \
	X(ka_normalmode_escape,               MODE_NORMAL_ESCAPE,               ,                                         "vis-mode-normal-escape",              "Reset count or remove all non-primary selections") \
	...
	X(ka_percent,                         CURSOR_PERCENT,                   ,                                         "vis-motion-percent",                  "Move to count % of file or matching item") \
	...
	X(ka_redo,                            REDO,                             ,                                         "vis-redo",                            "Redo last change") \
	X(ka_reg,                             REGISTER,                         ,                                         "vis-register",                        "Use given register for next operator") \
	X(ka_repeat,                          REPEAT,                           ,                                         "vis-repeat",                          "Repeat latest editor command") \
	X(ka_replace,                         REPLACE_CHAR,                     ,                                         "vis-replace-char",                    "Replace the character under the cursor") \
	X(ka_replacemode,                     MODE_REPLACE,                     .i = VIS_MOVE_NOP,                        "vis-mode-replace",                    "Enter replace mode") \
	X(ka_selection_end,                   SELECTION_FLIP,                   ,                                         "vis-selection-flip",                  "Flip selection, move cursor to other end") \
	X(ka_selections_align,                SELECTIONS_ALIGN,                 ,                                         "vis-selections-align",                "Try to align all selections on the same column") \
	...
	X(ka_selections_clear,                SELECTIONS_REMOVE_ALL,            ,                                         "vis-selections-remove-all",           "Remove all but the primary selection") \
	X(ka_selections_complement,           SELECTIONS_COMPLEMENT,            ,                                         "vis-selections-complement",           "Complement selections") \
	X(ka_selections_intersect,            SELECTIONS_INTERSECT,             ,                                         "vis-selections-intersect",            "Intersect with selections from mark") \
	...
	X(ka_selections_match_next,           SELECTIONS_NEW_MATCH_NEXT,        ,                                         "vis-selection-new-match-next",        "Select the next region matching the current selection") \
	X(ka_selections_match_skip,           SELECTIONS_NEW_MATCH_SKIP,        ,                                         "vis-selection-new-match-skip",        "Clear current selection, but select next match") \
	X(ka_selections_minus,                SELECTIONS_MINUS,                 ,                                         "vis-selections-minus",                "Subtract selections from mark") \
	...
	X(ka_selections_remove,               SELECTIONS_REMOVE_LAST,           ,                                         "vis-selections-remove-last",          "Remove primary selection") \
	...
	X(ka_selections_restore,              SELECTIONS_RESTORE,               ,                                         "vis-selections-restore",              "Restore selections from mark") \
	...
	X(ka_selections_save,                 SELECTIONS_SAVE,                  ,                                         "vis-selections-save",                 "Save currently active selections to mark") \
	X(ka_selections_trim,                 SELECTIONS_TRIM,                  ,                                         "vis-selections-trim",                 "Remove leading and trailing white space from selections") \
	X(ka_selections_union,                SELECTIONS_UNION,                 ,                                         "vis-selections-union",                "Add selections from mark") \
	X(ka_suspend,                         EDITOR_SUSPEND,                   ,                                         "vis-suspend",                         "Suspend the editor") \
	...
	X(ka_undo,                            UNDO,                             ,                                         "vis-undo",                            "Undo last change") \
	...
	X(ka_visualmode_escape,               MODE_VISUAL_ESCAPE,               ,                                         "vis-mode-visual-escape",              "Reset count or switch to normal mode") \
